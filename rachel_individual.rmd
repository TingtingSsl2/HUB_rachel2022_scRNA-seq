...
outdir="/Volumes/BIOINFORMATICS/projects/rachel2022/output/04_seurat_individual/"
...
flag=3 # 1=louvain, 2=GLMPCA, 3= leiden, 0=louvain and GLMPCA and leiden 
...
samples = c("Control-1", "Control-2", "Control-3", "QTau-1", "QTau-2", "QTau-3", "QASyn-1", "QASyn-2", "QASyn-3", "P251L-1", "CTRL-2", "Tau-KO-1", "P251L-2", "w3")
